/*! angular-google-maps 1.0.4 2014-01-11
...
function Cluster(a) {
  this.markerClusterer_ = a, this.map_ = a.getMap(), this.gridSize_ = a.getGridSize(), this.minClusterSize_ = a.getMinimumClusterSize(), this.averageCenter_ = a.getAverageCenter(), this.printable_ = a.getPrintable(), this.markers_ = [], this.center_ = null, this.bounds_ = null, this.clusterIcon_ = new ClusterIcon(this, a.getStyles())
}
...
(function () {
  ...
  angular.module("google-maps").factory("array-sync", ["add-events", function (a) {
    ...
    return b = function (b, c, d) {
      ...
      return f = c.$eval(d), e = a(b, {set_at: function (a) {
        ...
        var c, d, e, f, g, h, i, j;
        if (g = b, a) {
          for (c = 0, h = g.getLength(), e = a.length, d = Math.min(h, e), f = void 0; d > c;)i = g.getAt(c), f = a[c], (i.lat() !== f.latitude || i.lng() !== f.longitude) && g.setAt(c, new google.maps.LatLng(f.latitude, f.longitude)), c++;
          for (; e > c;)f = a[c], g.push(new google.maps.LatLng(f.latitude, f.longitude)), c++;
          for (j = []; h > c;)g.pop(), j.push(c++);
          return j
        }
      }, !0), function () {
  ...
  this.ngGmapModule("oo", function () {
    ...
    return b = ["extended", "included"], this.BaseObject = function () {
      ...
      return c.extend = function (c) {
        var d, e, f;
        for (d in c)e = c[d], a.call(b, d) < 0 && (this[d] = e);
        return null != (f = c.extended) && f.apply(0), this
      }, c.include = function (c) {
        var d, e, f;
        for (d in c)e = c[d], a.call(b, d) < 0 && (this.prototype[d] = e);
  ...
  this.ngGmapModule("directives.api.managers", function () {
    return this.MarkerManager = function (b) {
      ...
      return c(d, b), d.prototype.add = function (a, b) {
        ...
        var a, b, c, d, e;
        for (d = this.gMarkers, e = [], b = 0, c = d.length; c > b; b++)a = d[b], e.push(this.remove(a));
        return e
      }, d.prototype.draw = function () {
        var a, b, c, d, e, f, g, h, i, j = this;
        for (a = [], h = this.gMarkers, c = function (b) {
          return b.isDrawn ? void 0 : b.doAdd ? b.setMap(j.gMap) : a.push(b)
        }, d = 0, f = h.length; f > d; d++)b = h[d], c(b);
        for (i = [], e = 0, g = a.length; g > e; e++)b = a[e], i.push(this.remove(b, !0));
        return i
      }, d.prototype.clear = function () {
        var a, b, c, d;
  ...
  this.ngGmapModule("directives.api.utils", function () {
    return this.AsyncProcessor = {handleLargeArray: function (a, b, c, d, e, f) {
      var g;
      return null == e && (e = 100), null == f && (f = 0), void 0 === a || a.length <= 0 ? (d(), void 0) : (g = function () {
        var h, i;
        for (h = e, i = f; h-- && i < a.length;)b(a[i]), ++i;
  ...
  this.ngGmapModule("directives.api.utils", function () {
    return this.GmapUtil = {getLabelPositionPoint: function (a) {
      ...
      var e;
      return null == d && (d = void 0), e = angular.extend({}, c, {position: new google.maps.LatLng(a.latitude, a.longitude), icon: b, visible: null != a.latitude && null != a.longitude}), null != d && (e.map = d), e
    }, createWindowOptions: function (a, b, c, d) {
      return null != c && null != d ? angular.extend({}, d, {content: c, position: angular.isObject(a) ? a.getPosition() : new google.maps.LatLng(b.coords.latitude, b.coords.longitude)}) : void 0
    }, defaultDelay: 50}
  })
}.call(this), function () {
  ...
  this.ngGmapModule("directives.api.models.child", function () {
    return this.MarkerChildModel = function (b) {
      ...
      return c(d, b), d.include(directives.api.utils.GmapUtil), d.prototype.setMyScope = function (a, b, c) {
        ...
        var h, i;
        return null == g && (g = void 0), void 0 === c ? (this.myScope[a] = e(b, d), f || null != g && g(this.myScope), void 0) : (i = e(c, d), h = e(b, d), h === i || this.myScope[a] === h || (this.myScope[a] = h, f) ? void 0 : (null != g && g(this.myScope), this.gMarkerManager.draw()))
      }, d.prototype.destroy = function () {
        return this.myScope.$destroy()
      }, d.prototype.setCoords = function (a) {
        return a.$id === this.myScope.$id && void 0 !== this.gMarker ? null != a.coords ? (this.gMarker.setPosition(new google.maps.LatLng(a.coords.latitude, a.coords.longitude)), this.gMarker.setVisible(null != a.coords.latitude && null != a.coords.longitude), this.gMarkerManager.remove(this.gMarker), this.gMarkerManager.add(this.gMarker)) : this.gMarkerManager.remove(this.gMarker) : void 0
  ...
  this.ngGmapModule("directives.api.models.child", function () {
    return this.WindowChildModel = function (b) {
      function d(b, c, d, e, f, g, h, i, j, k) {
        this.element = j, null == k && (k = !1), this.destroy = a(this.destroy, this), this.hideWindow = a(this.hideWindow, this), this.showWindow = a(this.showWindow, this), this.handleClick = a(this.handleClick, this), this.watchCoords = a(this.watchCoords, this), this.watchShow = a(this.watchShow, this), this.createGWin = a(this.createGWin, this), this.scope = b, this.opts = c, this.mapCtrl = e, this.markerCtrl = f, this.isIconVisibleOnClick = d, this.initialMarkerVisibility = null != this.markerCtrl ? this.markerCtrl.getVisible() : !1, this.$log = directives.api.utils.Logger, this.$http = g, this.$templateCache = h, this.$compile = i, this.createGWin(), null != this.markerCtrl && this.markerCtrl.setClickable(!0), this.handleClick(), this.watchShow(), this.watchCoords(), this.needToManualDestroy = k, this.$log.info(this)
      }

      return c(d, b), d.include(directives.api.utils.GmapUtil), d.prototype.createGWin = function (a) {
        var b = this;
        return null == a && (a = !1), null == this.gWin && a && (this.opts = null != this.markerCtrl ? this.createWindowOptions(this.markerCtrl, this.scope, this.element.html(), {}) : {}), null != this.opts && void 0 === this.gWin ? (this.gWin = new google.maps.InfoWindow(this.opts), google.maps.event.addListener(this.gWin, "closeclick", function () {
          return null != b.markerCtrl && b.markerCtrl.setVisible(b.initialMarkerVisibility), null != b.scope.closeClick ? b.scope.closeClick() : void 0
        })) : void 0
        ...
        var a = this;
        return this.scope.$watch("coords", function (b, c) {
          return b !== c ? a.gWin.setPosition(new google.maps.LatLng(b.latitude, b.longitude)) : void 0
        }, !0)
      }, d.prototype.handleClick = function () {
        var a = this;
        return null != this.markerCtrl ? google.maps.event.addListener(this.markerCtrl, "click", function () {
          var b;
          return a.createGWin(!0), b = a.markerCtrl.getPosition(), null != a.gWin && (a.gWin.setPosition(b), a.gWin.open(a.mapCtrl)), a.markerCtrl.setVisible(a.isIconVisibleOnClick)
        }) : void 0
      }, d.prototype.showWindow = function () {
        var a = this;
        if (this.scope.templateUrl) {
          if (this.gWin)return this.$http.get(this.scope.templateUrl, {cache: this.$templateCache}).then(function (b) {
            var c, d;
            return d = a.scope.$new(), angular.isDefined(a.scope.templateParameter) && (d.parameter = a.scope.templateParameter), c = a.$compile(b.data)(d), a.gWin.setContent(c.get(0)), a.gWin.open(a.mapCtrl)
          })
        } else if (null != this.gWin)return this.gWin.open(this.mapCtrl)
  ...
  this.ngGmapModule("directives.api.models.parent", function () {
    return this.LayerParentModel = function (b) {
      function d(b, c, d, e, f, g, h) {
        var i = this;
        return this.scope = b, this.element = c, this.attrs = d, this.mapCtrl = e, this.$timeout = f, this.onLayerCreated = null != g ? g : void 0, this.$log = null != h ? h : directives.api.utils.Logger, this.createGoogleLayer = a(this.createGoogleLayer, this), null == this.attrs.type ? (this.$log.info("type attribute for the layer directive is mandatory. Layer creation aborted!!"), void 0) : (this.createGoogleLayer(), this.gMap = void 0, this.doShow = !0, this.$timeout(function () {
          return i.gMap = e.getMap(), angular.isDefined(i.attrs.show) && (i.doShow = i.scope.show), null !== i.doShow && i.doShow && null !== i.Map && i.layer.setMap(i.gMap), i.scope.$watch("show", function (a, b) {
            return a !== b ? (i.doShow = a, a ? i.layer.setMap(i.gMap) : i.layer.setMap(null)) : void 0
  ...
  this.ngGmapModule("directives.api.models.parent", function () {
    return this.MarkerParentModel = function (b) {
      ...
      return c(d, b), d.include(directives.api.utils.GmapUtil), d.prototype.onTimeOut = function (a) {
        var b, c = this;
        return b = this.createMarkerOptions(a.coords, a.icon, a.options, this.mapCtrl.getMap()), this.gMarker = new google.maps.Marker(b), this.element.data("instance", this.gMarker), google.maps.event.addListener(this.gMarker, "click", function () {
          return c.doClick && null != a.click ? c.$timeout(function () {
            return c.scope.click()
          }) : void 0
        }), this.setEvents(this.gMarker, a), this.$log.info(this)
      }, d.prototype.onWatch = function (a, b) {
        switch (a) {
          case"coords":
            return null != b.coords && null != this.gMarker ? (this.gMarker.setMap(this.mapCtrl.getMap()), this.gMarker.setPosition(new google.maps.LatLng(b.coords.latitude, b.coords.longitude)), this.gMarker.setVisible(null != b.coords.latitude && null != b.coords.longitude), this.gMarker.setOptions(b.options)) : this.gMarker.setMap(null);
          case"icon":
            if (null != b.icon && null != b.coords && null != this.gMarker)return this.gMarker.setOptions(b.options), this.gMarker.setIcon(b.icon), this.gMarker.setMap(null), this.gMarker.setMap(this.mapCtrl.getMap()), this.gMarker.setPosition(new google.maps.LatLng(b.coords.latitude, b.coords.longitude)), this.gMarker.setVisible(b.coords.latitude && null != b.coords.longitude);
            break;
          case"options":
            if (null != b.coords && null != b.icon && b.options)return this.gMarker.setMap(null), delete this.gMarker, this.gMarker = new google.maps.Marker(this.createMarkerOptions(b.coords, b.icon, b.options, this.mapCtrl.getMap()))
        }
      }, d.prototype.onDestroy = function () {
        var a;
        return void 0 === this.gMarker ? (a = void 0, void 0) : (this.gMarker.setMap(null), delete this.gMarker, a = void 0)
      }, d.prototype.setEvents = function (a, b) {
        var c, d, e, f;
        if (angular.isDefined(b.events) && null != b.events && angular.isObject(b.events)) {
          e = b.events, f = [];
          for (d in e)c = e[d], b.events.hasOwnProperty(d) && angular.isFunction(b.events[d]) ? f.push(google.maps.event.addListener(a, d, function () {
  ...
  this.ngGmapModule("directives.api.models.parent", function () {
    return this.MarkersParentModel = function (b) {
      function d(b, c, e, f, g) {
        ...
        var h;
        d.__super__.constructor.call(this, b, c, e, f, g), h = this, this.markers = [], this.markersIndex = 0, this.gMarkerManager = void 0, this.scope = b, this.bigGulp = directives.api.utils.AsyncProcessor, this.$timeout = g, this.$log.info(this)
      }
      ...
      return c(d, b), d.include(directives.api.utils.ModelsWatcher), d.prototype.onTimeOut = function (a) {
        ...
        var b = this;
        return null != a.doCluster && a.doCluster === !0 ? null != a.clusterOptions ? void 0 === this.gMarkerManager ? this.gMarkerManager = new directives.api.managers.ClustererMarkerManager(this.mapCtrl.getMap(), void 0, a.clusterOptions) : this.gMarkerManager.opt_options !== a.clusterOptions && (this.gMarkerManager = new directives.api.managers.ClustererMarkerManager(this.mapCtrl.getMap(), void 0, a.clusterOptions)) : this.gMarkerManager = new directives.api.managers.ClustererMarkerManager(this.mapCtrl.getMap()) : this.gMarkerManager = new directives.api.managers.MarkerManager(this.mapCtrl.getMap()), this.bigGulp.handleLargeArray(a.models, function (c) {
          var d;
          return a.doRebuild = !0, d = new directives.api.models.child.MarkerChildModel(b.markersIndex, c, a, b.mapCtrl, b.$timeout, b.DEFAULTS, b.doClick, b.gMarkerManager), b.$log.info("child", d, "markers", b.markers), b.markers.push(d), b.markersIndex++
        }, function () {
        }, function () {
          return b.gMarkerManager.draw(), angular.isDefined(b.attrs.fit) && null != a.fit && a.fit && b.fit(), a.markerModels = b.markers
        })
      }, d.prototype.reBuildMarkers = function (a) {
        if (a.doRebuild || void 0 === a.doRebuild)return _.each(this.markers, function (a) {
          return a.destroy()
        }), delete this.markers, this.markers = [], this.markersIndex = 0, null != this.gMarkerManager && this.gMarkerManager.clear(), this.createMarkers(a)
      }, d.prototype.onWatch = function (a, b, c, d) {
        return"models" !== a || this.didModelsChange(c, d) ? "options" === a && null != c ? (this.DEFAULTS = c, void 0) : this.reBuildMarkers(b) : void 0
      }, d.prototype.onDestroy = function () {
        var a, b, c, d;
        for (d = this.markers, b = 0, c = d.length; c > b; b++)a = d[b], a.destroy();
        return null != this.gMarkerManager ? this.gMarkerManager.clear() : void 0
      }, d.prototype.fit = function () {
        var a, b;
        return this.mapCtrl && null != this.markers && this.markers.length && (a = new google.maps.LatLngBounds, b = !1, _.each(this.markers, function (c) {
  ...
  this.ngGmapModule("directives.api.models.parent", function () {
    return this.WindowsParentModel = function (b) {
      function d(b, c, e, f, g, h, i, j, k) {
        this.interpolateContent = a(this.interpolateContent, this), this.setChildScope = a(this.setChildScope, this), this.createWindow = a(this.createWindow, this), this.setContentKeys = a(this.setContentKeys, this), this.createChildScopesWindows = a(this.createChildScopesWindows, this), this.watchOurScope = a(this.watchOurScope, this), this.watchDestroy = a(this.watchDestroy, this), this.watchModels = a(this.watchModels, this), this.watch = a(this.watch, this);
        var l, m, n, o, p, q = this;
        for (d.__super__.constructor.call(this, b, c, e, f, g, h, i, j, k), m = this, this.$interpolate = k, this.windows = [], this.windwsIndex = 0, this.scopePropNames = ["show", "coords", "templateUrl", "templateParameter", "isIconVisibleOnClick", "closeClick"], p = this.scopePropNames, n = 0, o = p.length; o > n; n++)l = p[n], this[l + "Key"] = void 0;
      ...
      return c(d, b), d.include(directives.api.utils.ModelsWatcher), d.prototype.watch = function (a, b, c) {
        ...
        return a.$watch(b, function (a, e) {
          var f, g, h, i, j;
          if (a !== e) {
            for (d[c] = "function" == typeof a ? a() : a, i = d.windows, j = [], g = 0, h = i.length; h > g; g++)f = i[g], j.push(function (a) {
        ...
        return a.$watch("models", function (a, c) {
          return b.didModelsChange(a, c) ? b.bigGulp.handleLargeArray(b.windows, function (a) {
            return a.destroy()
          }, function () {
          }, function () {
            return b.windows = [], b.windowsIndex = 0, b.createChildScopesWindows()
          }) : void 0
        }, !0)
      }, d.prototype.watchDestroy = function (a) {
        var b = this;
        return a.$on("$destroy", function () {
          return b.bigGulp.handleLargeArray(b.windows, function (a) {
            return a.destroy()
          }, function () {
          }, function () {
            return delete b.windows, b.windows = [], b.windowsIndex = 0
          })
        })
      }, d.prototype.watchOurScope = function (a) {
        var b, c, d, e, f, g = this;
        for (e = this.scopePropNames, f = [], c = 0, d = e.length; d > c; c++)b = e[c], f.push(function (b) {
          var c;
          return c = b + "Key", g[c] = "function" == typeof a[b] ? a[b]() : a[b], g.watch(a, b, c)
        }(b));
        return f
      }, d.prototype.createChildScopesWindows = function () {
        var a, b, c, d = this;
        return this.isIconVisibleOnClick = !0, angular.isDefined(this.linked.attrs.isiconvisibleonclick) && (this.isIconVisibleOnClick = this.linked.scope.isIconVisibleOnClick), a = this.linked.ctrls[0].getMap(), b = this.linked.ctrls.length > 1 && null != this.linked.ctrls[1] ? this.linked.ctrls[1].getMarkersScope() : void 0, c = angular.isUndefined(this.linked.scope.models), c && (void 0 === b || void 0 === b.markerModels && void 0 === b.models) ? (this.$log.info("No models to create windows from! Need direct models or models derrived from markers!"), void 0) : null != a ? null != this.linked.scope.models ? (this.models = this.linked.scope.models, this.firstTime && (this.watchModels(this.linked.scope), this.watchDestroy(this.linked.scope)), this.setContentKeys(this.linked.scope.models), this.bigGulp.handleLargeArray(this.linked.scope.models, function (b) {
          return d.createWindow(b, void 0, a)
        }, function () {
        }, function () {
          return d.firstTime = !1
        })) : (this.models = b.models, this.firstTime && (this.watchModels(b), this.watchDestroy(b)), this.setContentKeys(b.models), this.bigGulp.handleLargeArray(b.markerModels, function (b) {
          return d.createWindow(b.model, b.gMarker, a)
        }, function () {
        }, function () {
          return d.firstTime = !1
        })) : void 0
        ...
        }, !0), f = this.interpolateContent(this.linked.element.html(), a), e = this.createWindowOptions(b, d, f, this.DEFAULTS), this.windows.push(new directives.api.models.child.WindowChildModel(d, e, this.isIconVisibleOnClick, c, b, this.$http, this.$templateCache, this.$compile, !0))
        ...
        }, e = 0, f = g.length; f > e; e++)c = g[e], d(c);
        return a.model = b
    ...
    return this.Label = function (b) {
      ...
      return c(d, b), d.prototype.link = function (a, b, c, d) {
        return this.$timeout(function () {
          var b, c;
          return c = d.getMarker(), null != c && (b = new directives.api.models.child.MarkerLabelChildModel(c, a)), a.$on("$destroy", function () {
            return b.destroy()
          })
  ...
  this.ngGmapModule("directives.api", function () {
    return this.Marker = function (b) {
      ...
      return c(d, b), d.prototype.controller = ["$scope", "$element", function (a, b) {
        return{getMarker: function () {
          return b.data("instance")
        }}
  ...
  this.ngGmapModule("directives.api", function () {
    return this.Window = function (b) {
      ...
      return c(d, b), d.include(directives.api.utils.GmapUtil), d.prototype.link = function (a, b, c, d) {
        ...
        return this.$timeout(function () {
          var f, g, h, i, j, k, l;
          return h = !0, angular.isDefined(c.isiconvisibleonclick) && (h = a.isIconVisibleOnClick), i = d[0].getMap(), j = d.length > 1 && null != d[1] ? d[1].getMarker() : void 0, f = null != a.options ? a.options : {}, g = null != a && null != a.coords && null != a.coords.latitude && null != a.coords.longitude, k = g ? e.createWindowOptions(j, a, b.html(), f) : void 0, null != i && (l = new directives.api.models.child.WindowChildModel(a, k, h, i, j, e.$http, e.$templateCache, e.$compile, b)), a.$on("$destroy", function () {
            return l.destroy()
          }), null != e.onChildCreation && null != l ? e.onChildCreation(l) : void 0
        }, directives.api.utils.GmapUtil.defaultDelay + 25)
      }, d
  ...
  angular.module("google-maps").directive("googleMap", ["$log", "$timeout", function (a, b) {
    "use strict";
    var c, d;
    return d = function (a) {
      return angular.isDefined(a) && null !== a && a === !0 || "1" === a || "y" === a || "true" === a
    }, directives.api.utils.Logger.logger = a, c = {mapTypeId: google.maps.MapTypeId.ROADMAP}, {self: this, restrict: "ECMA", transclude: !0, replace: !1, template: '<div class="angular-google-map"><div class="angular-google-map-container"></div><div ng-transclude style="display: none"></div></div>', scope: {center: "=center", zoom: "=zoom", dragging: "=dragging", refresh: "&refresh", windows: "=windows", options: "=options", events: "=events", styles: "=styles", bounds: "=bounds"}, controller: ["$scope", function (a) {
      return{getMap: function () {
        return a.map
      }}
    }], link: function (e, f, g) {
      var h, i, j, k, l, m, n, o;
      if (!angular.isDefined(e.center) || !angular.isDefined(e.center.latitude) || !angular.isDefined(e.center.longitude))return a.error("angular-google-maps: could not find a valid center property"), void 0;
      if (!angular.isDefined(e.zoom))return a.error("angular-google-maps: map zoom property not set"), void 0;
      if (i = angular.element(f), i.addClass("angular-google-map"), l = {options: {}}, g.options && (l.options = e.options), g.styles && (l.styles = e.styles), g.type && (n = g.type.toUpperCase(), google.maps.MapTypeId.hasOwnProperty(n) ? l.mapTypeId = google.maps.MapTypeId[g.type.toUpperCase()] : a.error('angular-google-maps: invalid map type "' + g.type + '"')), o = new google.maps.Map(i.find("div")[1], angular.extend({}, c, l, {center: new google.maps.LatLng(e.center.latitude, e.center.longitude), draggable: d(g.draggable), zoom: e.zoom, bounds: e.bounds})), h = !1, google.maps.event.addListener(o, "dragstart", function () {
        ...
        return e.zoom !== o.zoom ? b(function () {
          return e.$apply(function (a) {
        ...
        var a;
        return a = o.center, m ? void 0 : b(function () {
          return e.$apply(function (b) {
        ...
        var a, c, d;
        return a = o.getBounds(), c = a.getNorthEast(), d = a.getSouthWest(), b(function () {
          return e.$apply(function (a) {
        ...
        for (j in e.events)e.events.hasOwnProperty(j) && angular.isFunction(e.events[j]) && google.maps.event.addListener(o, j, k(j))
      }
      return e.map = o, google.maps.event.trigger(o, "resize"), angular.isUndefined(e.refresh()) || e.$watch("refresh()", function (a, b) {
        var c;
        return a && !b ? (c = new google.maps.LatLng(a.latitude, a.longitude), d(g.pan) ? o.panTo(c) : o.setCenter(c)) : void 0
      }), e.$watch("center", function (a, b) {
        var c;
        if (a !== b)return m = !0, h || (c = new google.maps.LatLng(a.latitude, a.longitude), d(g.pan) ? o.panTo(c) : o.setCenter(c)), m = !1
      }, !0), e.$watch("zoom", function (a, b) {
        return a !== b ? o.setZoom(a) : void 0
      }), e.$watch("bounds", function (a, b) {
        var c, d, e;
        if (a !== b)return d = new google.maps.LatLng(a.northeast.latitude, a.northeast.longitude), e = new google.maps.LatLng(a.southwest.latitude, a.southwest.longitude), c = new google.maps.LatLngBounds(e, d), o.fitBounds(c)
      })
    }}
  }])
}.call(this), function () {
  ...
  angular.module("google-maps").directive("polygon", ["$log", "$timeout", function (a, b) {
    ...
    return g = function (a) {
      var b;
      for (b = 0; b < a.length;) {
        if (angular.isUndefined(a[b].latitude) || angular.isUndefined(a[b].longitude))return!1;
        b++
      }
      return!0
    }, d = function (a) {
      var b, c;
      for (c = new google.maps.MVCArray, b = 0; b < a.length;)c.push(new google.maps.LatLng(a[b].latitude, a[b].longitude)), b++;
      return c
    }, e = function (a, b) {
      var c, d;
      ...
      return angular.isUndefined(h.path) || null === h.path || h.path.length < 2 || !g(h.path) ? (a.error("polyline: no valid path attribute found"), void 0) : b(function () {
        var a, b, g, i, l, m, n, o;
        return a = k.getMap(), i = d(h.path), b = angular.extend({}, c, {map: a, path: i, strokeColor: h.stroke && h.stroke.color, strokeOpacity: h.stroke && h.stroke.opacity, strokeWeight: h.stroke && h.stroke.weight}), angular.forEach({clickable: !0, draggable: !1, editable: !1, geodesic: !1, visible: !0}, function (a, c) {
          ...
          var c, d, g, h, i, k, l;
          if (i = o.getPath(), b !== i) {
            if (!b)return o.setMap(null);
            for (o.setMap(a), c = 0, k = i.getLength(), g = b.length, d = Math.min(k, g); d > c;)l = i.getAt(c), h = b[c], (l.lat() !== h.latitude || l.lng() !== h.longitude) && i.setAt(c, new google.maps.LatLng(h.latitude, h.longitude)), c++;
            for (; g > c;)h = b[c], i.push(new google.maps.LatLng(h.latitude, h.longitude)), c++;
            for (; k > c;)i.pop(), c++;
            if (f(j.fit))return e(a, i)
          }
  ...
  angular.module("google-maps").directive("polyline", ["$log", "$timeout", "array-sync", function (a, b, c) {
    ...
    return h = function (a) {
      ...
      return angular.isUndefined(i.path) || null === i.path || i.path.length < 2 || !h(i.path) ? (a.error("polyline: no valid path attribute found"), void 0) : b(function () {
        var a, b, h, j;
        return b = function (a) {
          var b;
...
}.call(this), ClusterIcon.prototype.onAdd = function () {
  var a, b, c = this;
  ...
  if (null !== b && this.map_.getZoom() > b)return this.clusterIcon_.hide(), void 0;
  if (a < this.minClusterSize_)return this.clusterIcon_.hide(), void 0;
...
}, MarkerClusterer.BATCH_SIZE = 2e3, MarkerClusterer.BATCH_SIZE_IE = 500, MarkerClusterer.IMAGE_PATH = "http://google-maps-utility-library-v3.googlecode.com/svn/trunk/markerclustererplus/images/m", MarkerClusterer.IMAGE_EXTENSION = "png", MarkerClusterer.IMAGE_SIZES = [53, 56, 66, 78, 90], inherits(MarkerLabel_, google.maps.OverlayView), MarkerLabel_.getSharedCross = function (a) {
  var b;
